...
<!-- For checkpoint task examples and patterns, see @.kilo/get-shit-done/references/checkpoints.md -->
...
See `.kilo/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `.kilo/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `.kilo/get-shit-done/workflows/verify-phase.md` for verification logic.
