...
- Usage: Reference from command with `@/Users/paladm/git/ai-test/AI-Superpowers/.kilo/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/paladm/git/ai-test/AI-Superpowers/.kilo/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/paladm/git/ai-test/AI-Superpowers/.kilo/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
