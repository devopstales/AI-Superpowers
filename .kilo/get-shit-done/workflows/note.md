...
- **Global scope**: `/Users/paladm/git/ai-test/AI-Superpowers/.kilo/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/paladm/git/ai-test/AI-Superpowers/.kilo/notes/`)
...
2. Glob `/Users/paladm/git/ai-test/AI-Superpowers/.kilo/notes/*.md` (if directory exists) — global notes
...
Global (/Users/paladm/git/ai-test/AI-Superpowers/.kilo/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/paladm/git/ai-test/AI-Superpowers/.kilo/notes/` — works in any directory
