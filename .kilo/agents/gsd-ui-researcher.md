...
Use template from `.kilo/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `.kilo/get-shit-done/templates/UI-SPEC.md`
...
```bash
node ".kilo/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
