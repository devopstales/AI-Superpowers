...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /Users/paladm/git/ai-test/AI-Superpowers/.kilo
                  → checks /Users/paladm/git/ai-test/AI-Superpowers/.kilo/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /Users/paladm/git/ai-test/AI-Superpowers/.kilo/get-shit-done
                  → writes to /Users/paladm/git/ai-test/AI-Superpowers/.kilo/get-shit-done/hooks/
...
@/Users/paladm/git/ai-test/AI-Superpowers/.kilo/get-shit-done/references/thinking-models-debug.md
...
- Read @/Users/paladm/git/ai-test/AI-Superpowers/.kilo/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node "/Users/paladm/git/ai-test/AI-Superpowers/.kilo/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "/Users/paladm/git/ai-test/AI-Superpowers/.kilo/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/Users/paladm/git/ai-test/AI-Superpowers/.kilo/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
