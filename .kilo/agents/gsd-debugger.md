...
Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = .kilo/get-shit-done
                  → writes to .kilo/get-shit-done/hooks/
...
@.kilo/get-shit-done/references/thinking-models-debug.md
...
- Read @.kilo/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node ".kilo/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node ".kilo/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node ".kilo/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
