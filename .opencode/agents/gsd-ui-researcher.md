...
Use template from `/Users/paladm/git/ai-test/AI-Superpowers/.opencode/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/Users/paladm/git/ai-test/AI-Superpowers/.opencode/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "/Users/paladm/git/ai-test/AI-Superpowers/.opencode/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
