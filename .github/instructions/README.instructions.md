...
`common/coding-style.instructions.md` recommends immutability as a default principle. A language-specific `golang/coding-style.instructions.md` can override this:

> Idiomatic Go uses pointer receivers for struct mutation — see [common/coding-style.instructions.md](../common/coding-style.instructions.md) for the general principle, but Go-idiomatic mutation is preferred here.
