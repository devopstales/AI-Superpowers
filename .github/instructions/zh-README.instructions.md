...
`common/coding-style.instructions.md` 推荐不可变性作为默认原则。语言特定的 `golang/coding-style.md` 可以覆盖这一点：

> 惯用的 Go 使用指针接收器进行结构体变更 — 参见 [common/coding-style.instructions.md](../common/coding-style.instructions.md) 了解通用原则，但这里首选符合 Go 习惯的变更方式。
