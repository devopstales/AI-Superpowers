...
<required_reading>
@/Users/paladm/git/ai-test/AI-Superpowers/.cursor/get-shit-done/references/continuation-format.md
</required_reading>
...
```bash
INIT=$(node "/Users/paladm/git/ai-test/AI-Superpowers/.cursor/get-shit-done/bin/gsd-tools.cjs" init resume)
