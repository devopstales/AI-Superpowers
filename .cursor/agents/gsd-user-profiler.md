...
<reference>
@.cursor/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `.cursor/get-shit-done/references/user-profiling.md` to load:
