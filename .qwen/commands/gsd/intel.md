...
Intel system is disabled. To activate:
  ...
  node .gemini/get-shit-done/bin/gsd-tools.cjs config-set intel.enabled true
...
```bash
node .gemini/get-shit-done/bin/gsd-tools.cjs intel query <term>
```
...
```bash
node .gemini/get-shit-done/bin/gsd-tools.cjs intel status
```
...
```bash
node .gemini/get-shit-done/bin/gsd-tools.cjs intel diff
```
...
Project root: ${CWD}
gsd-tools path: .gemini/get-shit-done/bin/gsd-tools.cjs
