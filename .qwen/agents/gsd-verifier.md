...
<required_reading>
@.gemini/get-shit-done/references/verification-overrides.md
@.gemini/get-shit-done/references/gates.md
</required_reading>
...
@.gemini/get-shit-done/references/thinking-models-verification.md

At verification decision points, reference calibration examples:
@.gemini/get-shit-done/references/few-shot-examples/verifier.md
...
```bash
ROADMAP_DATA=$(node ".gemini/get-shit-done/bin/gsd-tools.cjs" roadmap analyze --raw)
```
