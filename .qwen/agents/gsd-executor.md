...
@.gemini/get-shit-done/references/thinking-models-execution.md
...
```bash
node .gemini/get-shit-done/bin/gsd-tools.cjs commit-to-subrepo "{type}({phase}-{plan}): {concise task description}" --files file1 file2 ...
```
