...
<reference>
@.gemini/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `.gemini/get-shit-done/references/user-profiling.md` to load:
