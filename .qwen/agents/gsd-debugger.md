...
Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = .gemini/get-shit-done
                  → writes to .gemini/get-shit-done/hooks/
...
@.gemini/get-shit-done/references/thinking-models-debug.md
...
- Read @.gemini/get-shit-done/references/common-bug-patterns.md
...
```bash
node ".gemini/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
